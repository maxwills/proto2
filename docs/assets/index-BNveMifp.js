...
#define LOW_PRECISION`),e}function lm(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Nc?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Ll?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===dn&&(e="SHADOWMAP_TYPE_VSM"),e}function hm(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ei:case Ti:e="ENVMAP_TYPE_CUBE";break;case $s:e="ENVMAP_TYPE_CUBE_UV";break}return e}function um(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Ti:e="ENVMAP_MODE_REFRACTION";break}return e}function dm(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Oc:e="ENVMAP_BLENDING_MULTIPLY";break;case Zl:e="ENVMAP_BLENDING_MIX";break;case $l:e="ENVMAP_BLENDING_ADD";break}return e}function fm(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function pm(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=lm(t),l=hm(t),h=um(t),u=dm(t),d=fm(t),m=tm(t),g=nm(r),v=i.createProgram();let f,p,T=t.glslVersion?"#version "+t.glslVersion+`
